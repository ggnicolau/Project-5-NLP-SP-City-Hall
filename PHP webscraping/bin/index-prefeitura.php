...
$url= file_get_contents ('https://www.prefeitura.sp.gov.br/cidade/secretarias/subprefeituras/sao_mateus/noticias/index.php?page='.strval($i));
//echo $url;
@$news->loadHTML($url);
//echo $news->saveHTML();
...
foreach ($newsList as $news) {
	$href = "https://www.prefeitura.sp.gov.br/cidade/secretarias/subprefeituras/sao_mateus/noticias/".$news->getAttribute('href');	
	...
	$filename = "subprefeitura/sao_mateus/".$date->format('Y-m-d')."-".strval($i+1)."-".$k.".txt";
