...
def vis(x):
    #Load file
    df = pd.read_csv('C:/Users/user/2. GIT_PROJECTS/Desafios/Projeto 5 - NLP Secretarias/tables_clean/'+str(x)+'.csv', sep=r'Γ')
    df = df.dropna()
...
#%%create your graphs!
vis('assistencia_social')
vis('capitalsp')
vis('controladoria_geral')
vis('cultura')
vis('desenvolvimento')
#vis('direitos_humanos')
vis('direitos_humanos-poprua')
vis('esportes')
vis('fazenda')
vis('gestao')
vis('governo')
...
vis('meio_ambiente')
vis('obras')
vis('pessoa_com_deficiencia')
vis('procuradoria_geral')
vis('relacoes_internacionais')
vis('relacoes_sociais')
vis('saude')
vis('seguranca_urbana-defesa_civil')
vis('seguranca_urbana-guarda_civil')
vis('subprefeituras')
vis('transportes')
vis('urbanismo')
vis('seguranca_urbana')
#%% Big table
vis('big_table')
