...
def vis(x):
    #Load file
    df = pd.read_csv('C:/Users/user/2. GIT_PROJECTS/Desafios/Projeto 5 - NLP Secretarias/tables_clean/haddad/'+str(x)+'.csv', sep=r'Γ')
    df = df.dropna()
    ...
    return None
#%%create your graphs!
vis('assistencia_social_haddad')
vis('capitalsp_haddad')
vis('controladoria_geral_haddad')
vis('cultura_haddad')
vis('desenvolvimento_haddad')
vis('direitos_humanos_haddad')
#vis('direitos_humanos-poprua_haddad')
vis('esportes_haddad')
vis('fazenda_haddad')
vis('gestao_haddad')
#vis('governo_haddad')
vis('habitacao_haddad')
vis('justica_haddad')
vis('meio_ambiente_haddad')
vis('obras_haddad')
vis('pessoa_com_deficiencia_haddad')
#vis('procuradoria_geral_haddad')
vis('relacoes_internacionais_haddad')
#vis('relacoes_sociais_haddad')
vis('saude_haddad')
vis('seguranca_urbana-defesa_civil_haddad')
vis('seguranca_urbana-guarda_civil_haddad')
vis('subprefeituras_haddad')
vis('transportes_haddad')
vis('urbanismo_haddad')
vis('seguranca_urbana_haddad')
#%% Big table
vis('big_table_haddad')
