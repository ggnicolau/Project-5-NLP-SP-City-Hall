...
def haddad(x):
    # Load file
    df = pd.read_csv('C:/Users/user/2. GIT_PROJECTS/Desafios/Projeto 5 - NLP Secretarias/tables/haddad/'+str(x)+'_haddad.csv', sep=r'Γ')
    ...
    df = df.dropna()
    # Save table
    df.to_csv('C:/Users/user/2. GIT_PROJECTS/Desafios/Projeto 5 - NLP Secretarias/tables_clean/haddad/'+str(x)+'_haddad.csv', sep=r'Γ', index=False)
    return allDone()

#%% Cleant it!
haddad('assistencia_social')
haddad('capitalsp')
haddad('controladoria_geral')
haddad('cultura')
haddad('desenvolvimento')
haddad('direitos_humanos')
haddad('direitos_humanos-poprua')
haddad('esportes')
haddad('fazenda')
haddad('gestao')
haddad('governo')
haddad('habitacao')
haddad('justica')
haddad('meio_ambiente')
haddad('obras')
haddad('pessoa_com_deficiencia')
haddad('procuradoria_geral')
haddad('relacoes_internacionais')
haddad('relacoes_sociais')
haddad('saude')
haddad('seguranca_urbana-defesa_civil')
haddad('seguranca_urbana-guarda_civil')
haddad('subprefeituras')
haddad('transportes')
haddad('urbanismo')
haddad('seguranca_urbana')
haddad('big_table')
